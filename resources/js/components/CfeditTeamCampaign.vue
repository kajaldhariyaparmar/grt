          ...
          <div class="cf-edit-campaign-wrap">
            ...
            <div class="custom-row">
              <div class="form-check">
                <input
                  type="checkbox"
                  v-model="form.is_joinbutton_public"
                  class="form-check-input"
                  id="cfEditJoinButton"
                />
                <label class="form-check-label" for="cfEditJoinButton"
                  >Display Join the Team button to the public.</label
                >
              </div>
            </div>
            <div class="custom-row">
              <button class="cf-btn-wrap" v-on:click="formSubmit">
  ...
  data() {
    return {
      form: {
        ...
        is_joinbutton_public: this.stringToBoolean(
          this.$route.params.campaign.is_joinbutton_public
        ),
