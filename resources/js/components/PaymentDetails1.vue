            ...
            <div class="col-sm-7">
                <div class="campaign-checkout-left-content">
                    ...
                    <p>{{ errors.cartEmpty }}</p>
                                        <!-- <a :href="base_url +'/payment-complete'" class="btn-wrap mt-4">Complete donation</a> -->
                                    </div>
                                </div>
                            </div>
              ...
              >
                <!-- <input type="hidden" name="item_name_1" value="Lansoprazole 15mg">
  ...
  methods: {
    ...
    mountAppleElements: function() {
      ...
      //  this.stripepublickey().then((data) => {
        ...
        self.stripe = Stripe("pk_test_LTOn51TCWCKF57JtVK9xQ3t7", {apiVersion: "2017-02-14"});
        ...
        self.elements = self.stripe.elements();
        self.prButton = self.elements.create('paymentRequestButton', {
