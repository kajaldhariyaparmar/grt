						...
						<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="mso-table-lspace: 0;mso-table-rspace: 0;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
							...
							<tr>
								<td valign="top" align="center" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
									<h2 style="font-family:Arial, Helvetica, sans-serif;font-size:18px; line-height:22px; color:#000000; text-align:left; padding:0px 0 20px; margin:0px; font-weight: 700; mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Hi {{$donation_data['author']}},</h2>
								</td>
							</tr>
							<tr>
								<td valign="top" align="center" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
									<h2 style="font-family:Arial, Helvetica, sans-serif;font-size:18px; line-height:22px; color:#000000; text-align:left; padding:0px 80px 20px 0px; margin:0px; font-weight: 700; mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Someone has donated &#163;{{$donation_data['amount']}} to your fundraising page.</h2>
								</td>
							</tr>
							<tr>
								<td valign="top" align="left" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
									<a href="{{url('fundraising')}}/{{$donation_data['slug']}}" style="font-family:Arial, Helvetica, sans-serif;display: inline-block;font-size: 16px;color: #ffffff;padding: 0 20px;height: 50px;line-height: 52px;font-weight: 600;border: 0px;border-radius: 3px;outline: none;background: #3da938;position: relative;cursor: pointer;overflow: hidden;transition: all .3s;z-index: 1;text-align: center; text-decoration: none; min-width: 200px;">See if they've left you a message</a>
								</td>
							</tr>
